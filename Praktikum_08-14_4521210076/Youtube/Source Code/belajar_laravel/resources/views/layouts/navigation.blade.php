        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        <x-nav-link :href="route('stores.my-stores')" :active="request()->routeIs('stores.my-stores')"
                                    class="text-gray-900 dark:text-gray-300 hover:text-gray-700 dark:hover:text-white">
                            {{ __('My Stores') }}
                        </x-nav-link>
                    @endauth
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('home')" :active="request()->routeIs('home')"
                                 class="text-gray-900 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                {{ __('Home') }}
